...
SELECT id AS '#', concat(`first_name`,' ',`last_name`) AS 'Full name',
job_title AS 'Title', salary AS 'Salary'
...
CREATE VIEW v_dep_4_and_salary AS
	SELECT * FROM employees
	WHERE department_id = 4 AND salary >= 1000
	ORDER BY id;

SELECT * FROM v_dep_4_and_salary;
